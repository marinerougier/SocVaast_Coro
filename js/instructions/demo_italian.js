...
italianDemo.extra_information_1 = {
  timeline: [{
    ...
    html: `
      ...
      <tr><td>Dove si trova attualmente?</td>
      ...
      <tr><td>Codice postale della sua posizione attuale:</td>
      <td style="vertical-align:top"><input name='ZIP' type='number' width='100%' required></td></tr>

      <tr><td>Come definirebbe il suo background etnico e/o culturale?</td>
      <td style="vertical-align:top; font-size:medium"><input name='ETHNICITY' type='text' required></td></tr>
      
      <tr><td>A parte lei, quanti membri della famiglia o persone care vivono nella sua attuale abitazione?</td>
      <td style="vertical-align:top"><input name='NB_FAMILY' type='number' width='100%' required></td></tr>
      
      <tr><td>A parte lei, quanti amici o coinquilini vivono nella sua attuale abitazione?</td>
...
italianDemo.extra_information_2 = {
  timeline: [{
    type: 'survey-html-form',
    html: `
      <div class='instructions' style='width:700px text-align:left; font-size:medium vertical-align:top; line-height: 1.0'>
      <table style='width:100%; border-collapse: separate; border-spacing: 1em'; vertical-align:top> 
      <tr><td>Qual è la sua età? </td>
      <td style="vertical-align:top"><input name='AGE' type='number' width='100%' required='true'></td></tr>
      
      <tr><td>Qual è il suo genere? </td>
      <td style="vertical-align:top; font-size:smaller">
        <label><input type='radio' name='SEX' value="1" required>&nbspfemmina&nbsp&nbsp</label>
        <label><input type='radio' name='SEX' value="2" required>&nbspmaschio&nbsp&nbsp</label>
        <label><input type='radio' name='SEX' value="3" required>&nbspaltro&nbsp&nbsp</label>
      </td></tr>

      <tr><td>Ha contatti professionali con i pazienti Covid-19 (i.e., come personale infermieristico, medico, ecc.)?</td>
      <td><label><input type='radio' name='OCCUPATION' value='1' required> sì </label>&nbsp&nbsp<label><input type='radio' name='OCCUPATION' value='2'>&nbsp no</label></td></tr>
      
      <!--
      <tr><td>Are you interested in receiving an individual feedback of your responses in comparison to the average responses?</td>
      <td style="vertical-align:top"><label><input type='radio' name='FEEDBACK' value='Yes' required> sì </label>&nbsp&nbsp<label><input type='radio' name='FEEDBACK' value='No'>&nbsp no</label></td></tr>
      -->
...
italianDemo.extra_information_techdiff = {
  timeline: [{
    type: 'survey-html-form',
    html: `
      <div class='instructions' style='width:700px text-align:left; font-size:medium vertical-align:top; line-height: 1.0'>
      ...
      <tr><td style="vertical-align:top">Ha incontrato qualche problema tecnico durante il completamento del compito del videogioco? Se sì, per favore lo descriva.</td>
...
italianDemo.extra_information_3 = {
  timeline: [{
    ...
    stimulus: `
      ...
      <p><b><center>Lo studio è completato. Grazie mille per la sua partecipazione!</center></b></p>
      <p>
      Se è interessato/a a ricevere inviti per studi futuri del progetto SCC, per favore inserisca il suo indirizzo email nel campo qui sotto:<br />
      </p><p>
      ...
      Per qualsiasi domanda, ci invii una mail a <a href="mailto:scc-project@ur.de?subject=SCC Study">scc-project@ur.de</a>
      </p><p>
      Per favore ci aiuti a invitare più persone possibili a partecipare a questo studio condividendo il link con i suoi amici e familiari 
      </p>
    ...
    `,
    choices: ["Fine dello studio", "Mostra il riepilogo delle risposte"]
  }],
  on_finish: function(data) {
