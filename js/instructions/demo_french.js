...
frenchDemo.extra_information_1 = {
  timeline: [{
    ...
    html: `
      ...
      <tr><td>Quel est le pays de votre résidence actuelle ?</td>
      ...
      <tr><td>Merci d'indiquer le code postal de votre résidence actuelle :</td>
      <td style="vertical-align:top"><input name='ZIP' type='number' width='100%' required></td></tr>

      <tr><td>Comment qualifieriez-vous votre origine ethnique et/ou culturelle ?</td>
      <td style="vertical-align:top; font-size:medium"><input name='ETHNICITY' type='text' required></td></tr>
      
      <tr><td>En dehors de vous, combien de membres de votre famille ou de proches habitent dans votre logement ?</td>
      <td style="vertical-align:top"><input name='NB_FAMILY' type='number' width='100%' required></td></tr>
      
      <tr><td>En dehors de vous, combien d'amis ou colocataires habitent dans votre logement ?</td>
...
frenchDemo.extra_information_3 = {
  timeline: [{
    ...
    stimulus: `
      ...
      <p><b><center>L'étude est terminée. Merci beaucoup pour votre participation !</center></b></p>
      <p>
      Si cela vous intéresse de recevoir des invitations aux futures études du project CSC, merci d'indiquer votre adresse mail ci-dessous:<br />
      </p><p>
      Adresse email :&nbsp <input type='text' name='EMAIL' id='EMAIL' size=60 onchange='window.email = this.value'>
      </p><p>
      Votre adresse sera stockée séparément de vos réponses à l'étude. Il ne nous sera donc pas possible de connecter votre adresse email à vos réponses à l'étude.
      </p><p>
      Pour toute question, envoyez-nous un mail à : <a href="mailto:scc-project@ur.de?subject=SCC Study">scc-project@ur.de</a>
      </p><p>
      Si vous le pouvez, aidez-nous à inviter autant de personnes que possible à participer à cette étude en partageant le lien de l'étude à vos amis et votre famille :
      </p>
    ...
    `,
    choices: ["Terminer l'étude", "Me montrer le résumé de mes réponses"]
  }],
  on_finish: function(data) {
