...
germanDemo.extra_information_1 = {
  timeline: [{
    ...
    html: `
      ...
      <tr><td>In welchem Land halten Sie sich derzeit auf?</td>
      ...
      <tr><td>Postleitzahl des Ortes, an dem Sie sich derzeit aufhalten:</td>
      <td style="vertical-align:top"><input name='ZIP' type='number' width='100%' required></td></tr>

      <tr><td>Wie würden Sie Ihre kulturelle bzw. ethnische Herkunft bezeichnen?</td>
      <td style="vertical-align:top; font-size:medium"><input name='ETHNICITY' type='text' required></td></tr>
      
      <tr><td>Zusätzlich zu Ihnen, wieviele Familienmitglieder oder nahestehende Personen leben noch in Ihrem aktuellen Haushalt?</td>
      <td style="vertical-align:top"><input name='NB_FAMILY' type='number' width='100%' required></td></tr>
      
      <tr><td>Zusätzlich zu Ihnen, wieviele Freunde oder Mitbewohner leben noch in Ihrem aktuellen Haushalt?</td>
...
germanDemo.extra_information_2 = {
  timeline: [{
    type: 'survey-html-form',
    html: `
      <div class='instructions' style='width:700px text-align:left; font-size:medium vertical-align:top; line-height: 1.0'>
      ...
      <tr><td>Ihr Geschlecht?</td>
      <td style="vertical-align:top; font-size:smaller">
        <label><input type='radio' name='SEX' value="1" required>&nbsp weiblich &nbsp&nbsp</label>
        <label><input type='radio' name='SEX' value="2" required>&nbsp männlich &nbsp&nbsp</label>
        <label><input type='radio' name='SEX' value="3" required>&nbsp divers &nbsp&nbsp</label>
      </td></tr>

      <tr><td>Haben Sie im Rahmen Ihrer beruflichen Tätigkeit Kontakt mit Covid-19-Patienten (z.B. als Pflegepersonal, als Arzt/Ärztin, etc.)?</td>
      <td><label><input type='radio' name='OCCUPATION' value='1' required> ja </label>&nbsp&nbsp<label><input type='radio' name='OCCUPATION' value='2'>&nbsp nein</label></td></tr>
...
germanDemo.extra_information_techdiff = {
  timeline: [{
    type: 'survey-html-form',
    html: `
      <div class='instructions' style='width:700px text-align:left; font-size:medium vertical-align:top; line-height: 1.0'>
      ...
      <tr><td style="vertical-align:top">
        Sind während der Bearbeitung der Videospiel Aufgabe technische Schwierigkeiten aufgetreten? Wenn ja, welche?
      </td><td>
        <textarea rows='3' cols='20' maxlength='256' wrap='soft' name='TECH_DIFF'></textarea>
      </td></tr>
      </table></div>
    `,
    button_label: "OK",
...
germanDemo.extra_information_3 = {
  timeline: [{
    ...
    stimulus: `
      ...
      <p><b><center>Die Studie ist nun zu Ende. Vielen Dank für Ihre Teilnahme.</center></b></p>
      <p>
      Wenn Sie eine Einladung zu zukünftigen Studien des SCC-Projektes erhalten möchte, können Sie hier Ihre Email-Adresse eintragen:<br />
      </p><p>
      E-Mail-Adresse:&nbsp <input type='text' name='EMAIL' id='EMAIL' size=60 onchange='window.email = this.value'>
      </p><p>
      Ihre Email-Adresse wird getrennt von Ihren Antworten in der Studie gespeichert. Es ist nicht möglich, Ihre Email-Adresse mit Ihren Antworten in der Studie in Verbindung zu bringen.
      </p><p>
      Bei Fragen schreiben Sie bitte an <a href="mailto:scc-project@ur.de?subject=SCC Study">scc-project@ur.de</a>
      </p><p>
      Bitte helfen Sie uns, so viele Menschen wie möglich zu unserer Studie einzuladen, indem Sie den Link mit Ihren Freunden teilen. Vielen Dank!
      </p>
    ...
    `,
    choices: ["Studie beenden", "Zusammenfassung der Antworten anzeigen"]
  }],
  on_finish: function(data) {
