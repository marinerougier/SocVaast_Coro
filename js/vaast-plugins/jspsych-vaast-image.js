...
***************************************************************/
 ...
 jsPsych.plugins['vaast-image'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    html_str += "<div style='position:absolute;right:0;top:0; width:100%; height:100%; background:url(" + trial.background_images[trial.position] + ") center no-repeat; background-color:#FF0000; background-size:" + background_width + "px " + background_height + "px;'>";
